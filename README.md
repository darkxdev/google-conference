...
'Capstone #1' is the first capstone project in the Microverse program, made for portfolio showcase and learning purposes.
...
- **Responsive for both desktop and mobile versions**
...
Feel free to check the [issues page](https://github.com/DarkxDev/Capstone-1/issues).
